...
bool downcast_call(Object &obj, const T &func) {
  switch (obj.get_id()) {
    ...
    case updateChatPosition::ID:
      ...
      return true;
    case updateChatDefaultMessageSenderId::ID:
      func(static_cast<updateChatDefaultMessageSenderId &>(obj));
      return true;
...
bool downcast_call(Function &obj, const T &func) {
  switch (obj.get_id()) {
    ...
    case setChatClientData::ID:
      ...
      return true;
    case setChatDefaultMessageSender::ID:
      func(static_cast<setChatDefaultMessageSender &>(obj));
      return true;
